"""✅ 現役 — 產出 `public/outline.json`(`public/verse.json` 的綱目對應版本)。

`public/outline.json` 的 source 欄位即為 bible.com YouVersion v4230,就是這支寫的。
預設輸出在 `output/outline_youversion.json`,實際以 `--out ../public/outline.json` 產出。
